...
function SignUp() {
    ...
    async function createNewAccount(event) {
        ...
        // Cheking Name field length
        if (signupData.fullName.length < 5) {
            toast.error("Name Should Be Atlist 5 Caracters");
            return;
        }
        ...
        if (
            ...
            toast.error(
                "Password should be 6 - 16 caracter long with atlist a number and special caracter"
            );
            return;
        }
        ...
        if (response?.payload?.success) navigat("/");
